...
$featured_image = get_theme_mod( 'stem_featured_image' );
if ( has_post_thumbnail() && ! empty( $featured_image ) ) :?>
	...
	<?php if ( is_search() || get_theme_mod( 'stem_post_content' ) == 'excerpt' ) : ?>
	...
	<div class="entry-content">			
		<?php
			$more = get_theme_mod( 'stem_read_more' ) . '<i class="fa fa-arrow-circle-o-right"></i>';
			the_content( $more );
